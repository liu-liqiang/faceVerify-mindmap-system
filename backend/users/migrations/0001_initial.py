    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('encoding', models.TextField(blank=True, help_text='人脸特征编码')),
                ('quality_score', models.FloatField(default=0.0, help_text='图片质量评分')),
                ('is_primary', models.BooleanField(default=False, help_text='是否为主要人脸图片')),
